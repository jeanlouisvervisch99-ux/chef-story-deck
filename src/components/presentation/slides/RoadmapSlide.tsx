...
const phases = [
  ...
  {
    version: "V2",
    title: "POS Intelligence & Predictive Ordering",
    timeline: "Q1 2027 → Q3 2027",
    icon: BarChart3,
    color: 'hsl(25 80% 55%)',
    status: "Planned",
    items: [
      "Theoretical vs actual usage (POS × recipes)",
      "Predictive ordering on sales patterns",
      "Improved invoice & delivery-note accuracy",
  ...
  {
    version: "V3",
    title: "Agentic Finance & Data Layer",
    timeline: "Q4 2027+",
    icon: Truck,
    color: 'hsl(160 50% 45%)',
    status: "Vision",
    items: [
      "Agentic bank & vendor statement reconciliation",
      "Weekly P&L forecasting",
      "Big Restaurant Data — wholesaler insights",
