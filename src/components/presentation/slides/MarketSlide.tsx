...
import { TrendingUp, MapPin, Calculator, Zap, Target, Brain, BarChart3 } from 'lucide-react';

const marketData = [
  { label: 'TAM', value: '25K', description: 'Belgium restaurants (NACE 56.10)', percent: 100 },
  { label: 'SAM', value: '15K', description: '60% addressable (independent, bistro-style)', percent: 60 },
  { label: 'SOM', value: '1,250', description: '5% market share — Year 3 target', percent: 5 },
];

const whyNowReasons = [
  {
    icon: Brain,
    title: "AI makes it possible now",
    description: "LLM-driven vision can extract data from messy invoices with 99% accuracy. This wasn't feasible 3 years ago."
  },
  {
    icon: Target,
    title: "No incumbent owns this layer",
    description: "Toast isn't in mainland Europe. Lightspeed is POS-only. Apicbase serves enterprise. The independent bistro is unserved."
  },
  {
    icon: BarChart3,
    title: "Margin pressure is at a peak",
    description: "Food costs up 15–20% since 2022. Restaurants can't afford guesswork on ingredient pricing anymore."
  },
];
  ...
  return (
    <div className="slide">
      <div className="flex items-center gap-3 mb-2 fade-up">
        ...
        <span className="text-muted-foreground font-medium">Belgium First → European Expansion</span>
      </div>
      <h2 className="slide-title fade-up">Market & Why Now</h2>
          ...
          <div>
            <div className="space-y-5 mb-6">
              {marketData.map((item, index) => (
                <div key={item.label} className="fade-up" style={{ animationDelay: `${0.3 + index * 0.2}s`, opacity: 0 }}>
                  ...
                  <div className="h-3 rounded-full overflow-hidden" style={{
                    ...
                    <div className="h-full rounded-full animate-chart-grow" style={{
                      width: `${item.percent}%`,
                      background: index === 2
            ...
            {/* The Math */}
            <div className="fade-up-delay-2 p-6 rounded-2xl relative overflow-hidden" style={{
          ...
          <div className="fade-up-delay-1">
            ...
            <div className="space-y-4">
              {whyNowReasons.map((reason, index) => (
                <div key={reason.title} className="fade-up p-4 rounded-2xl" style={{
                  ...
                  <div className="flex items-start gap-3">
                    <div className="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0" style={{ background: 'hsl(350 60% 30%)' }}>
