...
const visionPoints = [
  { icon: Database, text: "Centralized restaurant intelligence" },
  { icon: TrendingUp, text: "Supplier demand predictions" },
  { icon: Users, text: "Chef trend analytics" },
];
...
export const VisionSlide: React.FC = () => {
  return (
    <div className="slide">
      ...
      <h2 
        className="fade-up text-6xl font-black mb-6"
        style={{
        ...
        <div className="flex gap-10">
          ...
          <div className="flex-1 space-y-6">
            {visionPoints.map((point, index) => (
              <div
                key={point.text}
                className="fade-up feature-card flex items-center gap-5"
