...
const modules = ["Procurement", "AI Menu Scanning", "Staff Planning", "Recipe Database", "Analytics & P&L", "Working Capital"];
          ...
          <div className="flex-1">
            ...
            border: '1px solid rgba(255,255,255,0.6)'
              ...
              <div className="flex flex-wrap gap-2">
                {modules.map(mod => <span key={mod} className="px-3 py-1.5 rounded-full text-sm font-medium" style={{
